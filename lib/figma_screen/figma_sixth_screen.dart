...
class FigmaSixScreen extends StatefulWidget {
  const FigmaSixScreen({Key? key}) : super(key: key);

  @override
  State<FigmaSixScreen> createState() => _FigmaSixScreenState();
}

class _FigmaSixScreenState extends State<FigmaSixScreen> {
  @override
